...
public class QiscusRegex {
	...
	public static String pregMatch(String content, String pattern, int index) {
		...
		return QiscusTextCrawler.extendedTrim(match);
	}
	...
	public static List<String> pregMatchAll(String content, String pattern,
		...
		while (matcher.find()) {
			matches.add(QiscusTextCrawler.extendedTrim(matcher.group(index)));
		}
	...
	public static List<String> pregMatchAllImages(String content, String pattern) {
		...
		while (matcher.find()) {
			matches.add(QiscusTextCrawler.extendedTrim(matcher.group(3))
					+ matcher.group(4));
		}
